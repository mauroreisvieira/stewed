...
// Calendar
import { useCalendar, ICalendar, IDayOptions } from "@stewed/hooks";
import { isSameDay } from "@stewed/utilities";
      ...
      {data && (
        <>
          <Navigation
            ...
            prevSlot={
              <button className="prev" onClick={onHandlePrevMonth}>
                <svg
                  width={24}
            ...
            nextSlot={
              <button className="next" onClick={onHandleNextMonth}>
                <svg
                  width={24}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
          ...
          <Month className="month">
            {data.days?.map((day) => (
              <Day
                ...
                <time dateTime={day.dateFormatted}>{day.date.getDate().toString()}</time>
              </Day>
            ))}
          </Month>
        </>
