...
export const skin = {
  ...
  // Secondary -----------------------------------------------------------------
  "secondary-background": palette["cyan-500"],
  "secondary-background-faded": palette["cyan-100"],
  "secondary-background-hovered": palette["cyan-600"],
  "secondary-background-pressed": palette["cyan-700"],
  "secondary-border": palette["cyan-500"],
  "secondary-border-faded": palette["cyan-300"],
  "secondary-border-hovered": palette["cyan-600"],
  "secondary-foreground": palette["cyan-500"],
